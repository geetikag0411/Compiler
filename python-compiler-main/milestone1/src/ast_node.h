...
public:
    ...
    void make_tree(string output_file_path){
        ...
        this->index = ++ct;
        if(this->type != "STRING") cout << this->get_index() << " [label=\"" << this->type << " " << this->lexeme << "\\nLine" << this->line_no << "\"];" << endl;
        else cout << this->get_index() << " [label=\"" << this->type << "\"];" << endl;
        ...
        while(!q.empty()){
            ...
            for(auto &child: curr->children){
                ...
                if(child->is_terminal){
                    ...
                    if(child->get_category() == "KEYWORD") cout << "blue";
                    else if(child->get_category() == "OPERATOR") cout << "red";
                    else if(child->get_category() == "NAME") cout << "purple";
                    else if(child->get_category() == "DELIMITER") cout << "green";
                    else if(child->get_category() == "STRING") cout << "pink";
                    else cout << "orange";
                    cout << "];" << endl;
                }
                else{
