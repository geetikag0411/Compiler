...
public:
    ...
    st_entry(string name, Type type, int offset, int line_no, symbol_table *table, bool is_initialized) : name(name), type(type), offset(offset), line_no(line_no), table(table), is_initialized(is_initialized) {}
